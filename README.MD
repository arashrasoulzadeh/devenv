...
> **devenv** is a CLI tool for deterministic environment configuration management using TOML-based layering.
...
- `env` → overrides
- deterministic merge → output file
...
- Just predictable config merging
